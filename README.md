...
Foi feito um projeto que tem como principal objetivo fazer consultas em notícias sobre tecnologia. Para isso, foi criado um banco de dados, dados obtidos para popular este banco, e preparada consultas a serem feitas nestas notícias.
